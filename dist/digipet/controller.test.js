...
describe("ignoreDigipet", () => {
    it("decreases happiness,nutrition and discipline by 10", () => {
        // setup
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        expect(model_1.getDigipet()).toStrictEqual(model_1.INITIAL_DIGIPET);
        // act
    ...
    it("cannot decrease nutrition, happiness or discipline below 0", () => {
        // setup
        model_1.setDigipet({ happiness: 0, nutrition: 0, discipline: 0 });
        // act
        controller_1.ignoreDigipet();
        // assert
        expect(model_1.getDigipet()).toHaveProperty("nutrition", 0);
